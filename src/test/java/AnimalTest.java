...
public class AnimalTest {
    ...
    @Test(expected = Exception.class)
    public void testGetFoodNullAnimalKind() throws Exception {
        animal.getFood(null);
    }
    @Test(expected = Exception.class)
    public void testGetFoodEmptyString() throws Exception {
        animal.getFood("");
    }
    @Test(expected = Exception.class)
    public void testGetFoodWhitespaceOnly() throws Exception {
        animal.getFood("   ");
    }
    @Test
    public void testGetFoodCaseSensitivity() throws Exception {
        try {
    ...
    @Test
    public void testGetFoodTrimmedInput() throws Exception {
        List<String> food = animal.getFood(" Хищник ");
        assertEquals(List.of("Животные", "Птицы", "Рыба"), food);
    }
}